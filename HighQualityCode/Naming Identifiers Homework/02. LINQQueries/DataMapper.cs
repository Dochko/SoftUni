...
namespace Orders
{
    public class DataMapper
    {
        ...
        {
            var categoryReader = this.ReadFileLines(this.categoriesFileName, true);
        ...
        {
            var productReader = this.ReadFileLines(this.productsFileName, true);
        ...
        {
            var orderReader = this.ReadFileLines(this.ordersFileName, true);
        ...
        private IList<string> ReadFileLines(string filename, bool hasHeader)
        {
